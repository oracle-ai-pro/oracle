...
**Демо / лендинг:** [`about.html`](about.html) · **Приложение:** [`index.html`](index.html) · **Монолит:** [`full.html`](full.html)
...
- Общий origin с [Oracle Notepad](https://oracle-ai-pro.github.io/oracle-notepad) для проектов
- Service Worker [`sw.js`](sw.js) — push/напоминания (по возможности браузера)
...
1. Откройте `index.html` (или `full.html`) в современном браузере  
2. Примите consent / cookies-окно  
3. (Опционально) **Настройки → Сторонние API** — ключ Gemini `AQ.…` или другой провайдер  
4. Обзор фич: `about.html`
